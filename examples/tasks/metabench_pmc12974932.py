"""MetaBench task derived from review article PMC12974932."""
...
def get_task_config() -> Dict[str, object]:
    """Return the PMC12974932-derived MetaBench task configuration."""

    spec = TaskSpec(
        task_id="med_pmc12974932",
        topic="The Performance of Wearable Device\u2013Based Artificial Intelligence in Detecting Depression",
        domain="clinical evidence synthesis",
        target_words=9956,
        body_target_words=7900,
        expected_sections=6,
        practice_context="evidence-based clinical decision-making",
        organizer="systematic evidence synthesis framework",
        focus_points=[
                "The Performance of Wearable Device\u2013Based Artificial Intelligence in Detecting Depression",
        ],
        extra_must_include=[
                "AI",
                "PRISMA-DTA",
    ...
    config = build_main_task_config(
        spec,
        session_name="metabench_pmc12974932",
