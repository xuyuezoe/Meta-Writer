"""MetaBench task derived from review article PMC13051705."""
...
def get_task_config() -> Dict[str, object]:
    """Return the PMC13051705-derived MetaBench task configuration."""

    spec = TaskSpec(
        task_id="med_pmc13051705",
        topic="Effectiveness of discharge planning interventions on health-related outcomes among postpartum women",
    ...
    config = build_main_task_config(
        spec,
        session_name="metabench_pmc13051705",
