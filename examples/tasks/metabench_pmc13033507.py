"""MetaBench task derived from review article PMC13033507."""
...
def get_task_config() -> Dict[str, object]:
    """Return the PMC13033507-derived MetaBench task configuration."""

    spec = TaskSpec(
        task_id="med_pmc13033507",
        topic="Age- and region-specific gut microbiota dysbiosis in axial spondyloarthritis",
    ...
    config = build_main_task_config(
        spec,
        session_name="metabench_pmc13033507",
