"""MetaBench task derived from review article PMC13038443."""
...
def get_task_config() -> Dict[str, object]:
    """Return the PMC13038443-derived MetaBench task configuration."""

    spec = TaskSpec(
        task_id="med_pmc13038443",
        topic="Effects of digitalized Tai Chi intervention on muscle function and physical performance in older adults",
        domain="biomedical evidence synthesis",
        target_words=8284,
        body_target_words=6400,
        expected_sections=6,
    ...
    config = build_main_task_config(
        spec,
        session_name="metabench_pmc13038443",
