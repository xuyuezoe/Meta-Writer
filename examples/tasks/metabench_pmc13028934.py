"""MetaBench task derived from review article PMC13028934."""
...
def get_task_config() -> Dict[str, object]:
    """Return the PMC13028934-derived MetaBench task configuration."""

    spec = TaskSpec(
        task_id="med_pmc13028934",
        topic="Effects of Nicotinamide Mononucleotide Supplementation on Blood Pressure: A Systematic Review and Meta-Analysis of Randomized Controlled Trials",
        domain="clinical evidence synthesis",
        target_words=8354,
        body_target_words=6200,
        expected_sections=6,
    ...
    config = build_main_task_config(
        spec,
        session_name="metabench_pmc13028934",
