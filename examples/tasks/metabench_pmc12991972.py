"""MetaBench task derived from review article PMC12991972."""
...
def get_task_config() -> Dict[str, object]:
    """Return the PMC12991972-derived MetaBench task configuration."""

    spec = TaskSpec(
        task_id="med_pmc12991972",
        topic="Association between diabetes mellitus and risk of Alzheimer\u2019s disease: a meta-analysis and systematic review",
    ...
    config = build_main_task_config(
        spec,
        session_name="metabench_pmc12991972",
