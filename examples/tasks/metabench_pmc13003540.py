"""MetaBench task derived from review article PMC13003540."""
...
def get_task_config() -> Dict[str, object]:
    """Return the PMC13003540-derived MetaBench task configuration."""

    spec = TaskSpec(
        task_id="med_pmc13003540",
        topic="Prevalence of post-traumatic stress disorder in healthcare workers before and during COVID-19",
        ...
        focus_points=[
                "Prevalence of post-traumatic stress disorder in healthcare workers before and during COVID-19",
        ],
        extra_must_include=[
                "COVID-19",
                "PTSD",
    ...
    config = build_main_task_config(
        spec,
        session_name="metabench_pmc13003540",
