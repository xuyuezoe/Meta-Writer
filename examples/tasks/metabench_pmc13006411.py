"""MetaBench task derived from review article PMC13006411."""
...
def get_task_config() -> Dict[str, object]:
    """Return the PMC13006411-derived MetaBench task configuration."""

    spec = TaskSpec(
        task_id="med_pmc13006411",
        topic="Instant messaging-based digital health interventions for diabetes management: a domain-structured systematic review and meta-analysis of randomized controlled trials",
        domain="clinical evidence synthesis",
        target_words=10536,
        body_target_words=7800,
        expected_sections=6,
        practice_context="evidence-based clinical decision-making",
        organizer="systematic evidence synthesis framework",
        focus_points=[
                "Instant messaging-based digital health interventions",
                "diabetes management",
                "a domain-structured systematic review and meta-analysis of randomized controlled trials",
        ],
        extra_must_include=[
                "REML",
                "SMD",
    ...
    config = build_main_task_config(
        spec,
        session_name="metabench_pmc13006411",
