"""MetaBench task derived from review article PMC13095566."""
...
def get_task_config() -> Dict[str, object]:
    """Return the PMC13095566-derived MetaBench task configuration."""

    spec = TaskSpec(
        task_id="med_pmc13095566",
        topic="Systematic review of the efficacy and safety of biologically and tissue-derived therapies for the treatment of diabetic foot",
        domain="clinical evidence synthesis",
        target_words=6608,
        body_target_words=4400,
        expected_sections=6,
        practice_context="evidence-based clinical decision-making",
        organizer="systematic evidence synthesis framework",
        focus_points=[
                "Systematic review of the efficacy and safety of biologically and tissue-derived therapies",
    ...
    config = build_main_task_config(
        spec,
        session_name="metabench_pmc13095566",
